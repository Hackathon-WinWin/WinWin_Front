...
// ARTIST action
const REQUIRE_NUMBER = 'certificate/REQUIRE_NUMBER';
const REQUIRE_NUMBER_SUCCESS = 'certificate/REQUIRE_NUMBER_SUCCESS';
const REQUIRE_NUMBER_FAILURE = 'certificate/REQUIRE_NUMBER_FAILURE';
const CHECK_NUMBER = 'certificate/CHECK_NUMBER';
const CHECK_NUMBER_SUCCESS = 'certificate/CHECK_NUMBER_SUCCESS';
const CHECK_NUMBER_FAILURE = 'certificate/CHECK_NUMBER_FAILURE';

// HOTEL action
const CHECK_BUSINESS = 'certificate/CHECK_BUSINESS';
const CHECK_BUSINESS_SUCCESS = 'certificate/CHECK_BUSINESS_SUCCESS';
const CHECK_BUSINESS_FAILURE = 'certificate/CHECK_BUSINESS_FAILURE';

// INIT action
const INIT_PHONE_CERTIFY = 'certificate/INIT_PHONE_CERTIFY';
const INIT_BUSINESS_CERTIFY = 'certificate/INIT_BUSINESS_CERTIFY';
